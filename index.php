    ...
    <div class="page-content home-page">
        <section class="slider-section">
            <div class="owl-carousel owl-theme hero-slider">
                ...
                <div class="item">
                    <div class="img-wrap" style="background-image: url('./assets/images/slider-img-4.jpg')">
                        <div class="overlay"></div>
                        <div class="hero-caption">
                            <h2>Welcome to the</h2>
                            <h1>Alice <span>Book</span> Store</h1>
        ...
        <section class="advertisement">
            <div class="adv-wrap" style="background-image: url('./assets/images/slider-img-2.jpg')">
                <div class="overlay"></div>
                <div class="video-container">
                    <!-- Button trigger modal -->
                    <button type="button" class="btn video-btn hvr-pulse-grow" data-bs-toggle="modal"
                        data-src="https://www.youtube.com/embed/SKVcQnyEIT8" data-bs-target="#videoModal">
